...
Export a JSON snapshot of your entire club structure. Edit it, then re-import and the plugin will create any missing folders/campaigns/rooms and reorder everything to match. Great for setting up a club from scratch or keeping multiple clubs consistent.

### Metadata overrides
Override difficulty ratings, surface tags, and add extra tags locally without touching the TMX source. Useful for correcting mislabelled maps in your club.
